...
use super::{ExpandableBitsetPostingIterator, ImmutableBitsetPostingIterator};

pub struct BitsetPostingIterator<'a, const POSITIVE: bool> {
    current_docid: DocId,
    segment_cursor: usize,
    segment_meta_registry: SegmentMetaRegistry,
    persistent_segments: Vec<ImmutableBitsetPostingIterator<'a>>,
    building_segments: Vec<ExpandableBitsetPostingIterator<'a, POSITIVE>>,
}
...
impl<'a, const POSITIVE: bool> PostingIterator for BitsetPostingIterator<'a, POSITIVE> {
