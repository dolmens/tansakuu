...
pub use tantivy_common::file_slice::{FileHandle, FileSlice};
pub use tantivy_common::{AntiCallToken, OwnedBytes, TerminatingWrite};

pub static META_FILEPATH: Lazy<&'static Path> = Lazy::new(|| Path::new("meta.json"));

// pub(crate) use self::composite_file::{CompositeFile, CompositeWrite};
pub use self::directory::{Directory, DirectoryLock};
