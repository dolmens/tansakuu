...
impl Document for BTreeMap<Field, crate::document::OwnedValue> {
    type Value<'a> = &'a crate::document::OwnedValue;
    type FieldsValuesIter<'a> = FieldCopyingIterator<
        'a,
        btree_map::Iter<'a, Field, crate::document::OwnedValue>,
        crate::document::OwnedValue,
    >;
...
impl DocumentDeserialize for BTreeMap<Field, crate::document::OwnedValue> {
...
impl Document for HashMap<Field, crate::document::OwnedValue> {
    type Value<'a> = &'a crate::document::OwnedValue;
    type FieldsValuesIter<'a> = FieldCopyingIterator<
        'a,
        hash_map::Iter<'a, Field, crate::document::OwnedValue>,
        crate::document::OwnedValue,
    >;
...
impl DocumentDeserialize for HashMap<Field, crate::document::OwnedValue> {
    fn deserialize<'de, D>(mut deserializer: D) -> Result<Self, DeserializeError>
    where D: DocumentDeserializer<'de> {
