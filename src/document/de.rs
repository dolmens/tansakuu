...
use tantivy_common::{u64_to_f64, BinarySerializable, DateTime, VInt};

use super::se::BinaryObjectSerializer;
use super::{OwnedValue, Value};
use crate::document::type_codes;
...
//     use super::*;
//     use crate::document::existing_type_impls::JsonObjectIter;
//     use crate::document::se::BinaryValueSerializer;
//     use crate::document::OwnedValue;
//     use crate::document::{ReferenceValue, ReferenceValueLeaf};
...
//     fn deserialize_value(buffer: Vec<u8>) -> crate::document::OwnedValue {
//         let mut cursor = Cursor::new(buffer);
//         let deserializer = BinaryValueDeserializer::from_reader(&mut cursor).unwrap();
//         crate::document::OwnedValue::deserialize(deserializer).expect("Deserialize value")
//     }
...
//         assert_eq!(
//             value,
//             crate::document::OwnedValue::Date(DateTime::from_timestamp_micros(100))
//         );

//         let facet = Facet::from_text("/hello/world").unwrap();
//         let result = serialize_value(ReferenceValueLeaf::Facet(&facet).into());
//         let value = deserialize_value(result);
//         assert_eq!(value, crate::document::OwnedValue::Facet(facet));
...
//         let value = deserialize_value(result);
//         assert_eq!(value, crate::document::OwnedValue::PreTokStr(pre_tok_str));
//     }
...
//         assert_eq!(
//             value,
//             crate::document::OwnedValue::Array(vec![
//                 crate::document::OwnedValue::Null,
//                 crate::document::OwnedValue::Null,
//             ]),
//         );
...
//             crate::document::OwnedValue::Array(vec![
//                 crate::document::OwnedValue::Str(String::from("Hello, world")),
//                 crate::document::OwnedValue::Str(String::from("Some demo")),
//             ]),
//         );
...
//         let result = serialize_value(ReferenceValue::Array(elements.iter()));
//         let value = deserialize_value(result);
//         assert_eq!(value, crate::document::OwnedValue::Array(vec![]));
...
//                 crate::document::OwnedValue::Null,
//                 crate::document::OwnedValue::Str(String::from("Hello, world")),
//                 crate::document::OwnedValue::I64(12345),
//             ]),
//         );
//     }
...
//             crate::document::OwnedValue::Str(String::from("Hello")),
//         );
//         expected_object.insert(
//             "my-second-key".to_string(),
//             crate::document::OwnedValue::Null,
//         );
//         expected_object.insert(
//             "my-third-key".to_string(),
//             crate::document::OwnedValue::F64(123.0),
//         );
//         assert_eq!(value, crate::document::OwnedValue::Object(expected_object));
...
//             crate::document::OwnedValue::Array(vec![
//                 crate::document::OwnedValue::Null,
//                 crate::document::OwnedValue::Str(String::from("bobby of the sea")),
//             ]),
//         );
//         expected_object.insert(
//             "my-object".to_string(),
//             crate::document::OwnedValue::Object(
//                 vec![
//                     (
//                         "inner-1".to_string(),
//                         crate::document::OwnedValue::I64(-123i64),
//                     ),
//                     (
//                         "inner-2".to_string(),
//                         crate::document::OwnedValue::Str(String::from("bobby of the sea 2")),
//                     ),
//                 ]
//                 .into_iter()
//                 .collect(),
